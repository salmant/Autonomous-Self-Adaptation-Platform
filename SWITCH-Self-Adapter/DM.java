...
public class DM {
	public static void main(String[] args)  throws Exception {
		...
		double GoodPut_current = 1; 
		double GoodPut_previous = 1; 
		double GoodPut_past_previous = 1;
		///////////////////
		while(true){
		try {
			///////////////////
				...
				if (AVG_response_time > response_time_threshold) {
					...
					if (inc != 0) {
						...
						for (int i=0; i<inc; i++){
							...
							if (j==num_Servers) {System.out.println("All servers are occupied"); break; }// all servers are occupied.
						}
