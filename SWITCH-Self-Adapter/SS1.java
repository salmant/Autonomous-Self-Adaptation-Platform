...
public class AlarmTrigger {
	public static void main(String[] args)  throws Exception {
		...
		try {
			...
			///////////////////
			if (AVG_CPU > 80){
				if ((AVG_CPU >= 80) && (AVG_CPU < 85)) inc = 1;
				else if ((AVG_CPU >= 85) && (AVG_CPU < 95)) inc = 2;
					 else if (AVG_CPU >= 95) inc = 4;
			...
			///////////////////////////////////
			if (AVG_CPU < 50){
				if ((AVG_CPU > 40) && (AVG_CPU <= 50)) dec = 1;
				else if ((AVG_CPU > 30) && (AVG_CPU <= 40)) dec = 2;
					 else if (AVG_CPU <= 30) dec = 4;
